...
#Region "Métodos públicos"
    ...
    ''' <returns>Colección de objetos de la clase "CondicionAfiliatoria".</returns>
    ''' <remarks></remarks>
    Public Function ConsultaMes(ByVal CadenaConexion As String, ByVal TipoBaseDatos As String, ByVal Mes As Int16) As Entidades.CondicionesAfiliatorias
        Dim Valor As New Entidades.CondicionesAfiliatorias
        'Evalúa con que tipo de base de datos se esta trabajando
        Select Case TipoBaseDatos.ToUpper.Trim
            Case "SQL"
    ...
    ''' <remarks></remarks>
    Public Function ConsultaMesCantidad(ByVal CadenaConexion As String, ByVal TipoBaseDatos As String, ByVal Mes As Int16) As Int64
        Dim Valor As Int64 = 0
        'Evalúa con que tipo de base de datos se esta trabajando
        Select Case TipoBaseDatos.ToUpper.Trim
            Case "SQL"
            ...
            Case "OLEDB"
                ...
                Try
                    'Ejecuta acciones sobre la capa de datos
                    Valor = CapaDatos.ConsultaMesCantidadOLEDB(CadenaConexion, Mes)
                Catch ex As Exception
                    'Genera el nuevo error
                    Throw New ArgumentException(ex.Message)
                Finally
